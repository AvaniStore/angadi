...
function renderSales() {
  ...
  document.getElementById('page-sales').innerHTML = `
    <div class="page-header">
      ...
      <div style="font-size:13px;color:var(--text2)">${AppData.sales.length} total bills &nbsp;·&nbsp; ${fmt(totalRev)} revenue &nbsp;·&nbsp; <span style="color:var(--accent-dark)">${fmt(totalProfit)} profit</span></div>
    </div>
